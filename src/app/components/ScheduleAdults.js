...
const Schedule = () => {
  ...
  const events = [
    ...
    { day: 'MARDI', startHour: 18, endHour: 19, time: '18:00-19:00', label: 'JUDO', color: 'bg-orange-300' },
    { day: 'MARDI', startHour: 19, endHour: 20, time: '19:00-20:00', label: 'K1', color: 'bg-yellow-300' },
    ...
    { day: 'JEUDI', startHour: 18, endHour: 19, time: '18:00-19:00', label: 'JUDO', color: 'bg-orange-300' },

...
const Schedule = () => {
  ...
  const events = [
    { day: 'MARDI', startHour: 17, endHour: 18, time: '17:00-18:00', label: 'JUDO KIDS', color: 'bg-yellow-300' },
    ...
    { day: 'JEUDI', startHour: 17, endHour: 18, time: '17:00-18:00', label: 'JUDO KIDS', color: 'bg-yellow-300' },   

          ...
          <div className=" max-xs:gap-6 flex xs:gap-8 px-3 max-xs:flex-col-reverse">
              <div className=" blogsize text-white background ">
                ...
                <div className="flex flex-col justify-evenly ">
                    ...
                    <div className="max-xs:hidden background bg-white flex justify-center py-1 lg:text-lg xl:text-xl 2xl:text-2xl font-mono	font-family: ui-monospace border-4 border-black">AND MORE TO COME</div>
                </div>
          </div>
        </div>

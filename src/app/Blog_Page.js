...
function Blog() {
  return (
    <div className="flex justify-center mt-10">
      <div className="grid grid-cols-12   2xl:max-w-screen-2xl max-xs:gap-6  ">
        <div className="col-span-9 max-xl:col-span-12 max-md:flex max-md:flex-col-reverse max-xs:gap-6 ">
            <Gallery 
              ...
              flexDirection="row"
            />
          <div className=" max-xs:gap-6 flex xs:gap-8 px-3 max-md:flex-col-reverse ">
              <div className=" blogsize text-white">
                <span className="xxxs:text-7xl xxs:text-8xl xs:text-8xl sm:text-8xl md:text-9xl max-xs:flex max-xs:justify-center stroke-black stroke-2">BLOG</span>
              </div>

...
function Blog() {
  return (
    <div className="flex justify-center mt-10 border border-red-500">
      <div className="grid grid-cols-12 max-w-screen-2xl max-xs:gap-6 border border-blue-500 xs:h-screen ">
        <div className="col-span-9 max-xl:col-span-12 max-xs:flex max-xs:flex-col-reverse max-xs:gap-6 border border-green-500">
            <Gallery 
              ...
              flexDirection="row"
            />
          <div className=" max-xs:gap-6 flex xs:gap-8 px-3 max-xs:flex-col-reverse border border-orange-300">
              <div className=" blogsize text-white background ">
                <span className="max-xxs:text-7xl max-xs:text-8xl max-xs:flex max-xs:justify-center stroke-black stroke-2">BLOG</span>
              </div>
                <div className="flex flex-col justify-evenly ">
                    <div className="lg:text-lg xl:text-xl 2xl:text-2xl font-mono	font-family: ui-monospace max-xs:px-4 max-xxs:text-lg max-xs:text-xl text-left">
                    ...
                    <div className="max-xs:hidden background bg-white flex justify-center py-1 max-lg:text-sm lg:text-lg xl:text-xl 2xl:text-2xl font-mono	font-family: ui-monospace border-4 border-black">AND MORE TO COME</div>
                </div>
          </div>
        </div>
        ...
        <div className="col-span-3 background  max-xl:hidden overflow-y-auto border border-red-500 ">

...
const CotisationPage = () => {
    return (
        <div className="flex flex-col items-center pb-10" id="cotisations">
            ...
            <div className="flex justify-center w-full mt-10" >
                <div className="flex max-md:flex-col max-md:gap-6 justify-evenly items-center w-full  border background p-3 xxxs:max-w-screen-xxxs xxs:max-w-screen-xxs xs:max-w-screen-xxs sm:max-w-screen-xs md:max-w-screen-lg lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl">
                    <div className="flex flex-col">
                        <div className="bg-white p-3">
                            <div className="border border-black flex flex-col gap-2 p-16 max-lg:p-8 bg-white items-center">
                                <div className="flex gap-2 items-center">
                                    <div className="xxxs:text-md xxs:text-xl lg:text-xl xl:text-xl 2xl:text-2xl">tarif</div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="bg-black flex flex-col gap-2 p-10 text-white items-start">
                            <div className="lg:text-base xl:text-lg 2xl:text-xl font-mono	font-family: ui-monospace">- de 3 à 15 ans</div>

...
import Schedule from './components/ScheduleAdults';
    ...
    return (
        <div className="flex-col pb-10" id="profs">
            ...
            <div className="flex justify-center w-full mt-10 px-2">
                <div className="flex max-md:flex-col justify-evenly items-center w-full xs:max-w-screen-xs sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl gap-4 xl:gap-10 ">
                    <div className="flex flex-col max-md:w-3/4 w-1/3  ">
                        <Image src={images.Yuli3}  className="max-xs:h-[25rem] xs:h-[35rem]" style={DisciplineStyle} alt="gallery_image"/>
                    ...
                    <div className="flex flex-col max-md:w-3/4 w-1/3">
                        <Image src={images.Arthur} className="max-xs:h-[25rem] xs:h-[35rem] h-full " style={DisciplineStyle} alt="gallery_image"/>
                        <div className="bg-purple-700 flex flex-col gap-2 p-8 max-lg:p-8 text-white items-center">
                            ...
                            <div className="xxxs:text-lg xxs:text-lg xs:text-xl sm:text-xl md:text-xl lg:text-xl xl:text-xl 2xl:text-2xl font-mono	font-family: ui-monospace">professeur karate, K1, MMA </div>
                            <div className="xxxs:text-sm xxs:text-base xs:text-base sm:text-base md:text-base lg:text-lg xl:text-lg 2xl:text-xl font-mono	font-family: ui-monospace">
                            2nd Dan Shidokan Karate, competes in multiple tournaments all over the world, he now brings his expertise in diverse classes at Shidostudio, unless he's busy walking out his dog.
                            </div>
                            <div className="w-full h-px bg-white mt-3"></div> 
                        </div>
                    </div>
                    <div className="flex flex-col max-md:w-3/4 w-1/3">
                        <Image src={images.Tiago}  className="max-xs:h-[25rem] xs:h-[35rem] h-full" style={DisciplineStyle} alt="gallery_image"/>   
                        <div className="bg-purple-700 flex flex-col gap-2 p-8 max-lg:p-8 text-white items-center">
            ...
            <div className="flex justify-center w-full mt-10 px-2">
                <div className="flex max-md:flex-col justify-evenly items-center w-full xs:max-w-screen-xs sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl gap-4 xl:gap-10">
                    <div className="flex flex-col max-md:w-3/4 w-1/3">
                        <Image src={images.Said}  className="max-xs:h-[25rem] xs:h-[35rem]" style={DisciplineStyle} alt="gallery_image"/>
                        <div className=" bg-purple-700 flex flex-col gap-2 p-8 max-lg:p-8 text-white items-center ">
                            ...
                            <div className="xxxs:text-sm xxs:text-base xs:text-base sm:text-base md:text-base lg:text-lg xl:text-lg 2xl:text-xl font-mono	font-family: ui-monospace ">
                            He learned Jiu-Jitsu in Brazil when none was taught in Belgium yet at the time. He is a Black belt as long as we can remember.
                            </div>
                            <div className="w-full h-px bg-white mt-3"></div> 
                        </div>
                    </div>

    ...
    return (
        <div className="flex-col pb-10" id="profs">
            ...
            <div className="flex justify-center w-full mt-10 px-2">
                <div className="flex max-md:flex-col justify-evenly items-center w-full xs:max-w-screen-xs sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl gap-4 xl:gap-10">
                    <div className="flex flex-col max-md:px-24 max-sm:px-10 max-md:object-contain">
                        <Image src={images.Yuli}  className="md:h-[20rem] lg:h-[24rem] xl:h-[30rem] 2xl:h-[35rem]" style={DisciplineStyle} alt="gallery_image"/>
                        <div className=" bg-purple-700 flex flex-col gap-2 p-10 max-lg:p-8 text-white items-center">
                            ...
                            3rd Dan Shidokan Karate, 2019 World Champion, fights in Karate-K1-MMA, passionate by Martial Arts, he teaches for 8 years and now struggling with learning Jiu-Jitsu .
                            </div>
                            <div className="w-full h-px bg-white mt-3"></div> 
                        </div>
                    </div>
                    <div className="flex flex-col max-md:px-24 max-sm:px-10 max-md:object-contain">
                        <Image src={images.Arthur} className="md:h-[20rem] lg:h-[24rem] xl:h-[30rem] 2xl:h-[35rem]" style={DisciplineStyle} alt="gallery_image"/>
                        <div className="bg-purple-700 flex flex-col gap-2 p-10 max-lg:p-8 text-white items-center">
                    ...
                    <div className="flex flex-col max-md:px-24 max-sm:px-10">
                        <Image src={images.Tiago}  className="md:h-[20rem] lg:h-[24rem] xl:h-[30rem] 2xl:h-[35rem]" style={DisciplineStyle} alt="gallery_image"/>   
                        <div className="bg-purple-700 flex flex-col gap-2 p-10 max-lg:p-8 text-white items-center">
                            ...
                            <div className="xxxs:text-lg xxs:text-lg xs:text-xl sm:text-xl md:text-xl lg:text-xl xl:text-xl 2xl:text-2xl font-mono	font-family: ui-monospace">professeur karate, K1, MMA</div>
                            <div className="xxxs:text-sm xxs:text-base xs:text-lg sm:text-xl md:text-lg lg:text-lg xl:text-lg 2xl:text-lg font-mono	font-family: ui-monospace">
                            2nd Dan Shidokan Karate, started his Martial Arts journey with Kung-Fu at a young age, he now masters different disciplines, still competing, though he is a heavyweight, he knows how to be kind with beginners.
                            </div>
                            <div className="w-full h-px bg-white mt-3"></div> 
                        </div>
                    </div>
            ...
            <div className="flex justify-center w-full mt-10 px-2">
                <div className="flex max-md:flex-col justify-evenly items-center w-full xs:max-w-screen-xs sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl gap-4 xl:gap-10">
                    <div className="flex flex-col max-md:px-24 max-sm:px-10 max-md:object-contain">
                        <Image src={images.NOGI}  className="md:h-[20rem] lg:h-[24rem] xl:h-[30rem] 2xl:h-[35rem]" style={DisciplineStyle} alt="gallery_image"/>
                        <div className=" bg-purple-700 flex flex-col gap-2 p-10 max-lg:p-8 text-white items-center">
                    ...
                    <div className="flex flex-col max-md:px-24 max-sm:px-10 max-md:object-contain">
                        <Image src={images.Mubarak} className="md:h-[20rem] lg:h-[24rem] xl:h-[30rem] 2xl:h-[35rem]" style={DisciplineStyle} alt="gallery_image"/>
                        <div className="bg-purple-700 flex flex-col gap-2 p-10 max-lg:p-8 text-white items-center">
                    ...
                    <div className="flex flex-col max-md:px-24 max-sm:px-10">
                        <Image src={images.Saber}  className="md:h-[20rem] lg:h-[24rem] xl:h-[30rem] 2xl:h-[35rem]" style={DisciplineStyle} alt="gallery_image"/>   
                        <div className="bg-purple-700 flex flex-col gap-2 p-10 max-lg:p-8 text-white items-center">
